...
func main() {
	var src = "1234567890"
	cipherText := RsaEncrypt([]byte(src), "/home/jwang/Documents/Work/learnGo/Std/rsa/public.pem")

	// base64编码输出
	fmt.Printf("%s\n", base64.StdEncoding.EncodeToString(cipherText))

	// 解密
	plainText := RsaDecrypt(cipherText, "/home/jwang/Documents/Work/learnGo/Std/rsa/private.pem")
	fmt.Printf("%s\n", plainText)
}
